...
if(isset($_POST['submit'])) {	
	...
	$kode_pos = mysqli_real_escape_string($mysqli, $_POST['kode_pos']);
		...
		$result = mysqli_query($mysqli, "INSERT INTO tbdata (npsn, status, bentuk_pendidikan, nama_sekolah, sk_pendirian, tgl_pendirian, sk_izin_operasional, tgl_izin_operasional, alamat, 
