                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="b_pendidikan" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tgl_pendirian" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tgl_izin_operasional" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>ALAMAT</label>
