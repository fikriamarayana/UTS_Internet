...
<a href="add.html" class="btn btn-primary btn-sm">Add Data</a><br/><br/>

	<table class="table table-sm table-dark table-bordered" width='100%'>
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr class='bg-white text-primary'>";
		echo "<td>".$res['npsn']."</td>";
		...
		echo "<td><a class='btn btn-sm btn-success text-white' href=\"edit.php?npsn=$res[npsn]\">Edit</a> <a class='btn btn-danger btn-sm text-white mt-2' href=\"delete.php?npsn=$res[npsn]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
	</div>
